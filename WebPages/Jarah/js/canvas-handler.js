...
baseImage.src = 'https://sarvari1378.github.io/Files/Image_templates/Jarah_Template.png';
...
function drawCircleImage(imgElement, inputElement) {
    const rectWidth = 162, rectHeight = 51, rectColor = "rgba(126, 204, 191, 1)";
    const rectPosition = { x: 400, y: 360 }, cornerRadius = 20;
...
export function generateImage() {
    ...
    document.querySelectorAll("input[type='text']:not(#ringImageInput), textarea").forEach(input => {
        ...
        const font = input.dataset.font || "EnglishFont", color = input.dataset.color || "#231f20";
